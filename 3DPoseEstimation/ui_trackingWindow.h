...
"}"));
        ...
        pushButton_path->setGeometry(QRect(20, 60, 131, 41));
...
""));
    ...
    void retranslateUi(QMainWindow *TrackingWindow)
    {
        ...
        pushButton_path->setText(QApplication::translate("TrackingWindow", "\351\200\211\346\213\251\350\276\223\345\207\272\350\267\257\345\276\204", nullptr));
